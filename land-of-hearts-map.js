window.HPC_LAND_OF_HEARTS_MAP = {
  init(businesses) {
    ...
    function heartIcon(active=false) { const size = active ? 58 : 48; const anchor = active ? [29,50] : [24,42]; return L.divIcon({ className:'loh-heart-div-icon', html:'<div class="loh-heart-pin' + (active ? ' active' : '') + '"><span>♥</span></div>', iconSize:[size,size], iconAnchor:anchor, popupAnchor:[0,-44] }); }
