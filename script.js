...
if (footer) {
  ...
  footer.innerHTML = `<div class="footer-rainbow" aria-hidden="true"></div><div class="footer-grid"><div class="footer-brand"><h2>Heartland Pride Center</h2><p class="footer-tagline">Real people helping real people.</p><p>Building an affirming LGBTQ+ community resource hub for Polk County and Florida's Heartland.</p></div><div><h3>Explore</h3><a href="index.html">Home</a><a href="about.html">About</a><a href="programs.html">Programs & Services</a><a href="resources.html">Resource Directory</a><a href="crisis.html">Crisis & Immediate Support</a><a href="support.html">Donate</a></div><div><h3>Get Involved</h3><a href="volunteer.html">Volunteer</a><a href="partners.html">Partner With Us</a><a href="resources.html">Join the Resource Network</a><a href="contact.html">Contact HPC</a><a href="${givebutterUrl}" target="_blank" rel="noopener">Givebutter</a></div><div><h3>Connect</h3><a href="mailto:info@heartlandpridecenter.org">info@heartlandpridecenter.org</a><a href="https://www.facebook.com/people/Heartland-Pride-Center/61577565114125/" target="_blank" rel="noopener">Facebook</a><a href="https://www.instagram.com/heartlandpridecenter/" target="_blank" rel="noopener">Instagram</a><a href="crisis.html">Need immediate support?</a><a href="privacy.html">Privacy</a><a class="staff-portal-link" href="staff.html" aria-label="Staff Portal">Staff Portal</a></div></div><div class="footer-bottom"><p>© 2026 Heartland Pride Center, Inc. A Florida nonprofit organization.</p><p>Serving Polk County and the Central Florida Heartland.</p></div>`;
}
