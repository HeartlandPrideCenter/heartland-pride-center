...
if (navLinks) {
  ...
  // Rebuild the menu in one locked order on every page so links never reshuffle.
  navLinks.innerHTML = '';
...
brandPolish.textContent = `
  ...
  .privacy-page .page-hero{padding-top:clamp(92px,9vw,142px)!important}.privacy-page .page-hero .eyebrow{margin-bottom:22px!important;display:block!important}
